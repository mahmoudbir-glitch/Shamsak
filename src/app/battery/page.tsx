  ...
  return (
    <div className="w-full text-right" dir="rtl">
      <div className="flex justify-between items-center bg-white p-5 rounded-2xl shadow-sm mb-5 border border-slate-100">
        <h1 className="text-2xl font-extrabold text-emerald-600 flex items-center gap-1.5">🔋 حالة البطارية</h1>
        <div className="text-base font-semibold text-slate-500">بيانات تجريبية نشطة</div>
      </div>

      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 mb-4 text-center">
        <span className="text-base font-semibold text-slate-400 block mb-1">نسبة الشحن الحالية (SOC)</span>
      ...
      <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 mb-6 space-y-4">
        <div className="flex justify-between items-center border-b border-slate-100 pb-3 text-sm">
          ...
          <span className="font-semibold text-slate-800">{batteryStatus} • {chargePower.toLocaleString()} واط</span>
        </div>
