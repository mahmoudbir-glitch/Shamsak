...
export default function SettingsPage(){
 ...
 return <div className="space-y-4"><div><p className="text-xs font-bold text-blue-600">الإعدادات</p><h1 className="mt-1 text-2xl font-extrabold">إعدادات النظام</h1><p className="mt-1 text-sm text-slate-500">هذه النسخة تحفظ الإعدادات محليًا على الجهاز؛ لا تُرسل أسرارًا إلى الخادم.</p></div>
